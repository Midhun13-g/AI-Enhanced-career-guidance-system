...
public class AIServiceException extends RuntimeException {
    ...
    private static HttpStatus determineStatus(String errorCode) {
        ...
        return switch (errorCode) {
            ...
            case "AI_TIMEOUT", "SPACE_TIMEOUT", "REQUEST_TIMEOUT" -> HttpStatus.REQUEST_TIMEOUT;
            ...
            case "RATE_LIMITED", "TOO_MANY_REQUESTS", "PROVIDER_RATE_LIMITED", "PROVIDER_QUOTA_EXCEEDED" -> HttpStatus.TOO_MANY_REQUESTS;
            case "HF_BAD_GATEWAY" -> HttpStatus.BAD_GATEWAY;
            case "AI_SERVICE_UNAVAILABLE", "SPACE_UNAVAILABLE", "LOCAL_AI_UNAVAILABLE" -> HttpStatus.SERVICE_UNAVAILABLE;
            ...
            case "PROVIDER_ERROR", "HF_AUTH_ERROR", "INVALID_AI_RESPONSE", "INVALID_RESPONSE", "PARSE_ERROR", "GRADIO_UPLOAD_FAILED", "GRADIO_CALL_FAILED", "GRADIO_STREAM_EMPTY", "GRADIO_ERROR", "AI_PROCESSING_ERROR", "AI_SERVICE_ERROR" -> HttpStatus.BAD_GATEWAY;
